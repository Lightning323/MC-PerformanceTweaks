package org.lightning323.performancetweaks.flerovium.functions;
...
import static org.lightning323.performancetweaks.flerovium.functions.MathUtil.*;
...
public class FastEntityRenderer {
    ...
    private static void prepareVertices(PoseStack.Pose matrices, ModelCuboid cuboid, int color) {
        ...
        FACE = ~0;
        if (!ConfigManager.INSTANCE.entityBackFaceCulling)
            return;
